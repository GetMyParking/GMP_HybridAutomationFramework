...
public class OperationalHrs {
	...
	public void changeFilter() throws InterruptedException{
		...
		CommonUtility.GenericMethods.explicitWait(driver,btnFilter,10);
		btnFilter.click();
		...
		CommonUtility.GenericMethods.explicitWait(driver,btnApplyFilter,10);
	...
	public void CheckOperationalHrs(OperationalHrsMapper mapper) throws Exception
	{  
	...
	public void CheckOperationalHrs2(OperationalHrsMapper mapper) throws Exception
	{  
		String OpenHrs=mapper.getopeninghrs();
		String closeHrs=mapper.getclosinghrs();
		String  CurrentTime=findCurrentTime();
