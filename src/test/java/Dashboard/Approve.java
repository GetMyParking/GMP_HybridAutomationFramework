...
import Pages.Dashboard.ApprovePage;
...
WebDriver driver ;
	...
	public void lauchweb() throws IOException{
		...
		//AutomationConfiguration.Driver.get("https://gmpone-admin-db.getmyparking.com");
	}
	...
	public void clickapprove() throws InterruptedException{
		ApprovePage ap = PageFactory.initElements(CreateSession.getAutomationConfiguration().Driver, ApprovePage.class);
		ap.gotoApprove();
